...
#Comparison
JFC_comparand_a <- "e_h_f"
JFC_comparand_b <- "c_h_c"

#Identification of chip 
JFC_chip_value <- "PTK"

#Input data
JFC_directory_input_Median_SigmBg <- "input/June16_PTK-KRSA/_ExportstosKRSA_Median_SigmBg_210305150653.txt"
JFC_directory_input_Signal_Saturation <- "input/June16_PTK-KRSA/_ExportstosKRSA_Signal_Saturation_210305150655.txt"
...
JFC_comparison <- paste0(JFC_comparand_a,"-v-",JFC_comparand_b)
JFC_experiment_ID <- paste0(JFC_chip_value,JFC_comparison)


#Define Directories
JFC_directory_output <- "output/"
